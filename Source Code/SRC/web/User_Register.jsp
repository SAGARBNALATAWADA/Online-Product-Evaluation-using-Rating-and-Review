		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
					...
					<span class="login100-form-title p-b-51">
						...
						<input class="input100" type="text" name="username" placeholder="Username" pattern="[a-zA-Z]{2,}" title="Name Must in Letters" required>
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
						<input class="input100" type="password" name="pass" placeholder="Password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Mobile Number is required">
						<input class="input100" type="text" name="mobile" placeholder="Mobile Number" pattern="[0-9]{10}"
                                                       title="phone number must be digit" required>
						<span class="focus-input100"></span>
					</div>
                                        <div class="wrap-input100 validate-input m-b-16" data-validate = "Email is required">
						<input class="input100" type="mail" name="email" placeholder="Mail Id" required>
						<span class="focus-input100"></span>
					</div>
						...
						<input class="input100" type="file" name="file" placeholder="Username" style="margin-top: 20px;" required>
						<span class="focus-input100"></span>
					</div>
