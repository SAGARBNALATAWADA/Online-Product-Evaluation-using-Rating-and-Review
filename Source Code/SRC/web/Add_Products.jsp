				...
				<div class="flexslider js-fullheight">
                                   ...
                                   <div style="margin-left:30%;">
                                    ...
                                    <table>
                                        ...
                                        <tr><td><strong>Product Name</strong></td><td><input type="text" name="pname" pattern="[a-zA-Z]{2,}" title="Name Must in Letters" required></td></tr>
                                        <tr><td><strong>Price</strong></td><td><input type="text" name="price" title="Add Price" required="" pattern="\d+(\.\d{2})?"/></td></tr>
